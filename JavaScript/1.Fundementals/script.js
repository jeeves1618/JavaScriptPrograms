let life = 'What the hell!';
      if (life === 'What the hell')
            console.log(13+7+1);
      else
            console.log("hey I am in else condition");
...
let gList = ["Blind Watchmaker", "Republic", "Indian Trilogy", "Languages of Truth", "Post American World", "Liars Poker", "The Third Pillar", "Digital Gold"];
