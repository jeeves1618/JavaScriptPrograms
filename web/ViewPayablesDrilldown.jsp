    ...
    <div>
		...
		<table border=1; align=center>
            ...
            <tr><td align="center"><a href="http://localhost:8080/FinancialStatements/" class="button button2">Balance Sheet</a></td>
                ...
                <td align="center" ><a href="http://localhost:8080/FinancialStatements/AccountsPayableAnnual.jsp" class="button button2">Account Payables</a></td>
        ...
        <table border=1; align=center>
			...
			<col width="260"> 
			<col width="260">
				<tr><td align="center" colspan="5" color="Ivory"><b><a href="http://localhost:8080/FinancialStatements/AccountsPayableAnnual.jsp" class="button button2">Back to Account Payables Summay</a></td></b>
				</tr> 
			</table>
    </div>
</body>
