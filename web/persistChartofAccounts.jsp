        ...
        <table class="class2"border=1; align=center>
			...
			<%for (chartOfAccountsIterator = 0; chartOfAccountsIterator < ChartOfAccounts.numofElements; chartOfAccountsIterator++){ %>
				<tr><td align="center" ><%= chartOfAccountsList[chartOfAccountsIterator].identificationNumber%></td>
					...
					<td align="center" style="padding-left:0px"><b><form action="http://localhost:8080/FinancialStatements/UpdateChartOfAccounts.jsp?chartNumber=<%= chartOfAccountsList[chartOfAccountsIterator].identificationNumber%>" method="POST"><input type="submit" value="Update Amount"></form></b></td> 
				</tr>
            <%}%>
            </table>
    </div>
